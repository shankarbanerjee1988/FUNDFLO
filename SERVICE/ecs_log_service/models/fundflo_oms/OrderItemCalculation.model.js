...
class OrderItemCalculation extends Model { }
...
function defineModel() {
	...
	modelBuilder.addAttributes({
		...
		itemUuid: {
			...
			unique: "uqidx_fundflo_oms_order_item_calculation",
			field: 'item_uuid'
		},
		orderUuid: {
			type: DataTypes.UUID,
	...
	modelBuilder.configureOptions(false, false, 'order_item_calculation', 'fundflo_oms', {});
	return modelBuilder;
}

OrderItemCalculation.init(
	defineModel().getModel(),
	defineModel().getOptions()
);

module.exports = OrderItemCalculation;